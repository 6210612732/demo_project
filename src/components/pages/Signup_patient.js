...
export default class Signup extends Component {
    ...
    onSubmit = (e) => {
        ...
        axios.post('http://localhost:4000/api/patient/create-patient',PObject).then(res => 
            ...
            <MDBCol col='6' className="mb-5">
              <div className={`d-flex flex-column  justify-content-center  h-100 mb-4 ${styles.gradient_custom_2}`}>
                <div className="text-white px-3 py-4 p-md-5 mx-md-4">
                  ...
                  <MDBInput wrapperClass='mb-4' placeholder='แพ้ยา' onChange={this.onChangeallergic}  type='text'/>
                  <MDBTextArea wrapperClass='mb-4' placeholder='อาการแพ้' onChange={this.onChangegender} type='text'/>
